...
<div style="display: block;margin-bottom: 40px;"><div class="oics-button" style="float: right;position: absolute;margin-bottom: 10px;">
  <a href="https://api.aliyun.com/terraform?source=Module&activeTab=document&sourcePath=alibabacloud-automation%3A%3Acen-cross-region-networking-between-local-idc-and-remote-vpc&spm=docs.m.alibabacloud-automation.cen-cross-region-networking-between-local-idc-and-remote-vpc&intl_lang=EN_US" target="_blank">
...
| <a name="input_tr_peer_attachment"></a> [tr\_peer\_attachment](#input\_tr\_peer\_attachment) | The parameters of transit router peer attachment. | <pre>object({<br/>    transit_router_attachment_name  = optional(string, null)<br/>    auto_publish_route_enabled      = optional(bool, true)<br/>    route_table_propagation_enabled = optional(bool, true)<br/>    route_table_association_enabled = optional(bool, true)<br/>    bandwidth_type                  = optional(string, "DataTransfer")<br/>    bandwidth                       = optional(number, 100)<br/>    cen_bandwidth_package_id        = optional(string, null)<br/><br/>  })</pre> | `{}` | no |
